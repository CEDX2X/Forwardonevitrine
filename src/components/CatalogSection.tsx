...
export const CatalogSection: React.FC<CatalogSectionProps> = ({
  ...
  return (
    <section id="catalog" className={`py-20 transition-colors duration-200 relative border-t border-b ${
            ...
            >
              <div>
                ...
                <div className="p-5 space-y-3">
                  ...
                  <h3 className={`font-extrabold text-base leading-snug line-clamp-1 transition-colors ${
              ...
              <div className="p-5 pt-0 space-y-3">
                <div className={`flex items-baseline justify-between pt-3 border-t ${isLight ? 'border-slate-100' : 'border-white/10'}`}>
                  <div className={`text-xs ${isLight ? 'text-slate-600' : 'text-[#738591]'}`}>Tarif / jour :</div>
                  <div className={`text-lg font-black ${isLight ? 'text-[#5362DC]' : 'text-[#FFAD5B]'}`}>
                ...
                <div className="grid grid-cols-2 gap-2">
                  <button
                    ...
                    className={`flex items-center justify-center gap-1 py-2 px-2 rounded-full text-xs font-semibold cursor-pointer ${
