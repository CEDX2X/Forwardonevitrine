...
export const BlogSection: React.FC<BlogSectionProps> = ({ articles, theme = 'light' }) => {
  ...
  return (
    <section id="blog" className={`py-20 transition-colors duration-200 relative ${
          ...
          <div className="max-w-4xl mx-auto space-y-8 animate-fade-in">
            ...
            <div className="space-y-4">
              ...
              <div className={`flex flex-wrap items-center gap-4 text-xs border-b pb-4 ${
                ...
                <span>Par <strong className={isLight ? 'text-black' : 'text-slate-200'}>{selectedArticle.author}</strong> ({selectedArticle.authorRole})</span>
                <span>•</span>
                <span className="flex items-center gap-1"><Clock className="w-3.5 h-3.5 text-[#5362DC]" /> {selectedArticle.readTime}</span>
                <span>•</span>
                <span>Publié le {selectedArticle.date}</span>
                <span>•</span>
                <span className="flex items-center gap-1"><Eye className="w-3.5 h-3.5 text-[#5362DC]" /> {selectedArticle.views} vues</span>
              </div>
            </div>
